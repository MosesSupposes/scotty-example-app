...
/* package haskell-web-service-from-scratch-0.1.0.0 */
#ifndef VERSION_haskell_web_service_from_scratch
#define VERSION_haskell_web_service_from_scratch "0.1.0.0"
#endif /* VERSION_haskell_web_service_from_scratch */
#ifndef MIN_VERSION_haskell_web_service_from_scratch
#define MIN_VERSION_haskell_web_service_from_scratch(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
#define CURRENT_COMPONENT_ID "haskell-web-service-from-scratch-0.1.0.0-inplace-haskell-web-service-from-scratch"
